...
const blocknames = ["ARYABHATTA","BHASKARA","BRAHMAGUPTA","CHARAKA","GARGI","KAPILA","KAUTILYA","MAITREYI","RAMANUJA","SUSRUTA","VARAHAMIHIRA","VYASA"];
const games = ["SOLO DANCE",
"DUO-TRIO DANCE",
"GROUP DANCE",
...
function Culti() {
    return (
        <DivBar blocknames={blocknames} games={games} points={points} title={"Culti" }/>
    )
}
