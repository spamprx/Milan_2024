...
{
    return (
        <footer className="bg-[#12022D] flex flex-col justify-center items-center h-fit">
            ...
            <div className="flex flex-col md:flex-row lg:flex-row min-w-[300px] relative h-fit justify-center items-center">
                <img src={Follow} alt="Follow" className="w-1/2 h-1/2 md:w-1/6 p-2 mx-auto"/>
                <img src={Location} alt="Location" className="w-1/2 h-1/2 md:w-1/6 mx-auto"/>
                <img src={Contact} alt="Contact" className="w-1/2 h-1/2 md:w-1/6 p-2 mx-auto"/>
            </div>
        </footer>
    );
}
