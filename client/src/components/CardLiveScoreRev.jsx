      ...
      <div className="relative flex w-fit max-w-screen-sm bg-gradient-to-r from-[#D9d9d9] to-gray-400 rounded-lg">
        ...
        <div className="flex flex-row absolute inset-0 items-center justify-center z-30 translate-x-20 -translate-y-12">
          <div className="flex w-16 flex-col translate-x-1 gap-2">
            <span className="text-4xl font-bold font-be-vietnam text-[#4B16B2] text-center">
              {score1}
            </span>
            <span className="text-xs truncate mt-3 font-be-vietnam w-full text-[#F3F1F6]">
              {team1}
            </span>
            <hr className="w-16 border-1 border-[#F3F1F6] mb-2" />
            <span className="text-center font-bold mt-2 font-be-vietnam text-[#F3F1F6]">
              {extra1}
            </span>
          </div>
          <div className="flex flex-col -translate-x-2 gap-2 mb-3">
            <span className="text-4xl font-bold font-be-vietnam text-white mb-6 -translate-y-2">
              :
            </span>
            <hr className="w-16 border-2 border-[#F3F1F6]" />
            <span className="text-xs scale-110 w-fit px-1 mx-auto font-semibold font-be-vietnam bg-[#F3F1F6] text-[#4B16B2] rounded-2xl">
              {extra}
            </span>
          </div>
